import { A as getToolCaller, C as detectMediaType, D as filterNullable, Dt as getErrorMessage, E as fetchWithValidatedRedirects, F as isFullMediaType, G as retryWithExponentialBackoff, H as readResponseWithSizeLimit, I as isProviderReference, K as safeParseJSON, L as isUrlSupported, M as isBuffer, P as isExecutableTool, Q as zodSchema, R as lazySchema, T as executeTool, Tt as TypeValidationError, U as resolve, X as withUserAgentSuffix, Y as validateTypes, _t as union, at as array, bt as APICallError, ct as discriminatedUnion, d as cancelResponseBody, dt as looseObject, ft as never, g as convertUint8ArrayToBase64, gt as string, ht as record, k as getRuntimeEnvironmentUserAgent, l as asArray, lt as lazy, mt as object, n as GatewayError, nt as _instanceof, o as DEFAULT_MAX_DOWNLOAD_SIZE, ot as boolean, p as convertBase64ToUint8Array, pt as number, q as safeValidateTypes, r as gateway, rt as _null, s as DownloadError, st as custom, t as GatewayAuthenticationError, tt as _enum, u as asSchema, ut as literal, v as createIdGenerator, vt as unknown, xt as InvalidPromptError, yt as AISDKError } from "./@ai-sdk/gateway+[...].mjs";
...
function isNodeRuntime() {
	var _a25;
	return typeof processModule !== "undefined" && ((_a25 = processModule.release) == null ? void 0 : _a25.name) === "node";
}
