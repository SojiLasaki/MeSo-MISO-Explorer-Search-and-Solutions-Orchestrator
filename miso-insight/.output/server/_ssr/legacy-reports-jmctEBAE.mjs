//#region node_modules/.nitro/vite/services/ssr/assets/legacy-reports-jmctEBAE.js
/**
...
var LEGACY_REPORTS = [
	{
		...
		category: "Guidance",
		format: "PDF",
		description: "Official mapping of historical market reports to their MISO Data Exchange API replacements.",
	...
	},
	{
		...
		category: "Guidance",
		format: "PDF",
		description: "MISO's list of retired or transitioning market reports, with Data Exchange migration guidance.",
	...
	},
	{
		...
		category: "Archive",
		format: "Web page",
		description: "Official MISO archive for previously published market-report material and retained files.",
	...
	},
	{
		...
		category: "Pricing",
		format: "PDF",
		description: "Reader’s guide for the legacy day-ahead pricing report and the terms used in that report.",
	...
	},
	{
		...
		category: "Pricing",
		format: "PDF",
		description: "Reader’s guide for the legacy real-time pricing report, including real-time price terminology.",
	...
	},
	{
		...
		format: "PDF",
		description: "Reader’s guide for the legacy daily forecast and actual-load report by local resource zone.",
	...
	},
	{
		...
		category: "Archive",
		format: "Web page",
		description: "MISO’s active market-report directory, including reader guides and links to retained report materials.",
...
function legacyReportBySourceId(sourceId) {
	return LEGACY_REPORTS.find((report) => report.source_id === sourceId);
}
function searchLegacyReports(query) {
...
var LEGACY_REPORT_SOURCES = LEGACY_REPORTS.map((report) => ({
...
//#endregion
export { legacyReportBySourceId as n, searchLegacyReports as r, LEGACY_REPORT_SOURCES as t };
