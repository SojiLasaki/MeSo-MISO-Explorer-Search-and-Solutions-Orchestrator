  ...
  head: () => ({
    meta: [
      ...
      { title: "MISO AI" },
      {
        name: "description",
        content:
          "Ask for the information. MISO AI finds the right MISO data, report or API for you.",
      },
      { property: "og:title", content: "MISO AI" },
      {
    ...
    links: [
      ...
      { rel: "icon", href: "/miso-logo.svg", type: "image/svg+xml" },
    ],
  }),
