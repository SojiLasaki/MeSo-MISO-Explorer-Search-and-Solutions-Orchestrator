...
CATALOG = [
    ...
    },
    {
        ...
        "public_path": "/api/MarketPricing/GetRealTimeFiveMinExPost/Current",
        ...
        "parameters": [
            param("date", "Market date", False, "path", description="Optional context only; the public endpoint returns the current five-minute interval"),
