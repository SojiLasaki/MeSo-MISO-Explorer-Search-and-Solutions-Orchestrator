...
GENERAL_EXPLANATION = re.compile(r"\b(explain|what does|what is|define)\b[\s\w-]{0,60}\b(real[ -]?time lmp|lmp|market clearing price|mcp|marginal congestion component|mcc|transmission congestion)\b", re.I)
